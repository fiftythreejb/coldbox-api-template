...
component {
	...
	// Module Properties
	this.title 				= "modTemplate"; // replace with module name
	this.author 			= "";
	this.webURL 			= "";
	this.description 		= "";
	this.version			= "1.0.0";
	...
	// Module Entry Point
	this.entryPoint			= "api/modTemplate";// "api/{{endpoint name}}; // add a value if the handler will be hit from the api entrypoint"
	// Inherit Entry Point
	this.inheritEntryPoint 	= false;
	// Model Namespace
	this.modelNamespace		= "modTemplate"; // replace with module name
	// CF Mapping
	this.cfmapping			= "modTemplate"; // replace with module name
	// Auto-map models
